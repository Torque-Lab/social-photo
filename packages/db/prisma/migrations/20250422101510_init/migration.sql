...
CREATE TABLE "Save" (
    ...
    CONSTRAINT "Save_pkey" PRIMARY KEY ("userId","photoId")
);
...
-- AddForeignKey
ALTER TABLE "Save" ADD CONSTRAINT "Save_photoId_fkey" FOREIGN KEY ("photoId") REFERENCES "Photo"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
